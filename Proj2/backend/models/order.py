...
class GroupOrder(db.Model):
    ...
    # Relationships
    items = db.relationship('GroupOrderItem', backref='order', lazy=True, cascade='all, delete-orphan')

    __table_args__ = (db.UniqueConstraint('group_id', 'username', name='unique_group_order'),)
